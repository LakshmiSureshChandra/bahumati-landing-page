        ...
        >
          <div className="md:w-2/3 mb-8 md:mb-0 text-center md:text-left z-10">
            ...
            <p className="text-indigo-200 mb-6 max-w-xl">
              We're here to help! Whether it's about gifting, self-gifting, or app features — reach out to us anytime for quick answers and friendly support.
            </p>
            {/* UPDATED: Changed <button> to <a> and added mailto link */}
            <a 
              href="mailto:Bahumati369@gmail.com"
              className="bg-white text-indigo-600 px-6 py-3 rounded-lg font-semibold flex items-center gap-2 mx-auto md:mx-0 w-max"
            >
              Contact Us 24x7
