  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-heading mb-6 leading-tight">
          Celebrate Moments With{' '}
          <span className="text-primary">Meaningful Digital Gifts</span>
        </h1>
        
        <p className="text-xl md:text-2xl text-body mb-8 max-w-2xl mx-auto">
          A modern way to invest & gift in India.
        </p>
